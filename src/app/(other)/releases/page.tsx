      ...
      <div className="section-block py-2">
        ...
        <div className="rounded-md md:rounded-lg py-2">
          <div className="bg-light/30 pt-4 md:pt-2 text-black rounded-md md:rounded-lg">
            ...
            <div className="grid md:grid-cols-2 p-4">
              <div>
                  <a href="https://github.com/LostMa-ERC/JonasScraper" target="_blank" rel="noreferrer">
                    <h2 className="md:text-2xl text-xl italic">Jonas</h2>
                  </a>
              ...
              <div>
                  <a href="https://github.com/LostMa-ERC/french-catalogue-scraper" target="_blank" rel="noreferrer">
                    <h2 className="md:text-2xl text-xl italic">Catalogue collectif de France, Archives et Manuscrits</h2>
                  </a>
                  <p className="font-light text-xs md:text-base tracking-wide md:px-8">
              ...
              <div>
                  <a href="https://github.com/LostMa-ERC/search-archives-manuscrits" target="_blank" rel="noreferrer">
                    <h2 className="md:text-2xl text-xl italic">Archives et Manuscrits (search)</h2>
                  </a>
                  <p className="font-light text-xs md:text-base tracking-wide md:px-8">
