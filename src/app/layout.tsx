...
export default function RootLayout({
  ...
  <head>
    ...
    <meta property="og:description" content="ERC Project"/>
    <meta property="og:image" content="public/images/lostma_logo.png"/>
    {/* Twitter meta tags */}
    ...
    <meta name="twitter:description" content="ERC Project"/>
    <meta name="twitter:image" content="public/images/lostma_logo.png"/>
  </head>
  <body className="
